...
class FormidableAutoCompleteOption {
	...
	public function field_field_option_form( $field, $display, $values ) {
		...
		$lookup_args   = FormidableAutoCompleteAdmin::get_args_for_get_options_from_setting( $field );
		$lookup_fields = FormidableAutoCompleteAdmin::get_lookup_fields_for_watch_row( $field );

		require( FAC_VIEW_PATH . '/autopopulate-values.php' );
	}
